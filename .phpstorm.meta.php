...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.tiers.0.letter' => 'string',
            'app.tiers.0.title' => 'string',
            'app.tiers.0.description' => 'string',
            'app.tiers.0.color' => 'string',
            'app.tiers.1.letter' => 'string',
            'app.tiers.1.title' => 'string',
            'app.tiers.1.description' => 'string',
            'app.tiers.1.color' => 'string',
            'app.tiers.2.letter' => 'string',
            'app.tiers.2.title' => 'string',
            'app.tiers.2.description' => 'string',
            'app.tiers.2.color' => 'string',
            'app.tiers.3.letter' => 'string',
            'app.tiers.3.title' => 'string',
            'app.tiers.3.description' => 'string',
            'app.tiers.3.color' => 'string',
            'app.tiers.4.letter' => 'string',
            'app.tiers.4.title' => 'string',
            'app.tiers.4.description' => 'string',
            'app.tiers.4.color' => 'string',
            'app.tiers.5.letter' => 'string',
            'app.tiers.5.title' => 'string',
            'app.tiers.5.description' => 'string',
            'app.tiers.5.color' => 'string',
            'app.tiers.6.letter' => 'string',
            'app.tiers.6.title' => 'string',
            'app.tiers.6.description' => 'string',
            'app.tiers.6.color' => 'string',
            ...
            'filesystems.links./home/grafikart/Lab/MyTierList/public/storage' => 'string',
...
'app.aliases.Vite','app.tiers.0.letter','app.tiers.0.title','app.tiers.0.description','app.tiers.0.color',
'app.tiers.1.letter','app.tiers.1.title','app.tiers.1.description','app.tiers.1.color','app.tiers.2.letter',
'app.tiers.2.title','app.tiers.2.description','app.tiers.2.color','app.tiers.3.letter','app.tiers.3.title',
'app.tiers.3.description','app.tiers.3.color','app.tiers.4.letter','app.tiers.4.title','app.tiers.4.description',
'app.tiers.4.color','app.tiers.5.letter','app.tiers.5.title','app.tiers.5.description','app.tiers.5.color',
'app.tiers.6.letter','app.tiers.6.title','app.tiers.6.description','app.tiers.6.color','auth.defaults.guard',
...
'filesystems.links./home/grafikart/Lab/MyTierList/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
'inertia.testing.page_extensions','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'session.same_site','session.partitioned','simkl.id','simkl.secret','concurrency.default',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','ide-helper.filename',
...
'tier','move','home','export',
'sync','storage.local',);
        registerArgumentsSet('views', 
'app','movies.export','movies.index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SIMKL_CLIENT',
'SIMKL_SECRET',);
